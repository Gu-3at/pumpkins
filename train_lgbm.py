...
def train_and_evaluate_lightgbm(df):
    np.random.seed(42)
        ...
        for md in params['model__max_depth']:
            for lr in params['model__learning_rate']:
                for nl in params['model__num_leaves']:
                    ...
                    # 评估模型
                    score = lgb_pipeline.score(X_test, y_test)
    ...
    final_model.set_params(
        ...
        model__num_leaves=best_params['num_leaves']
    )
